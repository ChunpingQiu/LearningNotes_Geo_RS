...
% function: cut image into patches, and save to folders by city: image band guf osm
% input:
...
%         partNum: the index of part of this patch file
% output:
%         numData: # of each in this saved file
%         label_RC: Label, RC of the actually used label
function [numData, label_RC] = saveImg2matS2L8(centerRCLable, img, train_test, imgPatchDir, cityMonth, patchHalf, partNum, city)
